...
// Props interface for the Visiolog SVG logo component
export interface VisiologLogoProps {
  // Optional CSS class names for styling and sizing
  className?: string
  // Fill color of the vector path
  color?: string
}

// Vector emblem component representing the Visiolog brand
export function VisiologLogo({ className = 'w-6 h-6', color = 'currentColor' }: VisiologLogoProps) {
  return (
    // SVG container rendering the brand glyph
    <svg
      ...
      aria-label="Visiolog"
    >
      {/* Transformed group ensuring correct coordinate system orientation */}
      <g transform="translate(0,512) scale(1,-1)" fill={color}>
        {/* Precise geometric path for the document extraction emblem */}
...
export const AkosilLogo = VisiologLogo
