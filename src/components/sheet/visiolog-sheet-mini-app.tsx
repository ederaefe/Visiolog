...
// Interface defining props passed to the Visiolog spreadsheet mini application
export interface VisiologSheetMiniAppProps {
  projectId: string
  projectName: string
...
export type AkosilSheetMiniAppProps = VisiologSheetMiniAppProps

// Primary Visiolog spreadsheet mini app component
export function VisiologSheetMiniApp({
  projectId,
  projectName,
  initialCsvData,
  userTier = 'free',
  ...
  const syncToMasterSheet = useCallback(
    async (gridToSave: string[][]) => {
      ...
      try {
        ...
        localStorage.setItem(`visiolog_sheet_cache_${projectId}`, csvString)
...
// Backward compatibility alias for legacy imports
export const AkosilSheetMiniApp = VisiologSheetMiniApp
